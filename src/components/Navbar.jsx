      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-blue-50 border-t border-blue-200 px-6 py-4 sticky top-20 z-40 shadow-sm">
          <div className="flex flex-col gap-2">
            <Link to='/recruit-us' onClick={toggleMenu}>
              <button className='w-full text-left font-medium text-base px-4 py-3 hover:bg-blue-200 rounded-lg transition-colors duration-200'>
                Why Recruit?
              </button>
            </Link>
            ...
            <Link to='/corporate-connect-home' onClick={toggleMenu}>
              <button className='w-full text-left font-medium text-base px-4 py-3 bg-blue-500 text-white hover:bg-blue-600 rounded-lg transition-colors duration-200'>
                Corporate Connect
              </button>
            </Link>
            ...
            <div className="border-t border-blue-200 pt-2 mt-2">
              ...
              <Link to='/resources' onClick={toggleMenu}>
                <button className='w-full text-left font-medium text-base px-6 py-2.5 hover:bg-blue-200 rounded-lg transition-colors duration-200'>
                  📚 Resources
                </button>
              </Link>
