    ...
    <footer className="bg-blue-100 text-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
        ...
        <div className="block md:hidden">
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="bg-white rounded-lg p-5 border border-blue-200 shadow-sm">
              <h4 className="font-bold mb-3 text-blue-700 text-lg">Dean CEOA</h4>
              <p className="text-lg mb-2 font-semibold text-slate-800">Dr. Sarang P. Gumfekar</p>
              <div className="space-y-2">
                <p className="text-sm flex items-center text-slate-600">
                  <FaPhone className="mr-3 text-green-600" size={14} />
                  +91 76200 63191
                </p>
                <p className="text-sm flex items-center text-slate-600">
                  <FaEnvelope className="mr-3 text-blue-600" size={14} />
                  <a href="mailto:deanceoa@iitrpr.ac.in" className="text-blue-600 hover:text-blue-800 transition-colors duration-200 hover:underline">
            ...
            {/* Faculty Section */}
            <div className="bg-white rounded-lg p-5 border border-blue-200 shadow-sm">
              <h4 className="font-bold mb-3 text-blue-700 text-lg">Faculty In-Charge</h4>
              <p className="text-lg mb-2 font-semibold text-slate-800">Dr. Tharamani C.N.</p>
              <div className="space-y-2">
                <p className="text-sm flex items-center text-slate-600">
                  <FaPhone className="mr-3 text-green-600" size={14} />
                  +91 82838 40769
                ...
                <p className="text-sm flex items-center text-slate-600">
                  <FaEnvelope className="mr-3 text-blue-600" size={14} />
                  <a href="mailto:chair.cdp@iitpr.ac.in" className="text-blue-600 hover:text-blue-800 transition-colors duration-200 hover:underline">
            ...
            {/* Organizers Section */}
            <div className="bg-white rounded-lg p-5 border border-blue-200 shadow-sm">
              <h4 className="font-bold mb-4 text-blue-700 text-lg">Organizers</h4>
              
              <div className="space-y-4">
                <div className="pb-4 border-b border-slate-200">
                  <p className="text-lg font-semibold mb-2 text-slate-800">Nikhil Garg</p>
                  <div className="space-y-2">
                    <p className="text-sm flex items-center text-slate-600">
                      <FaPhone className="mr-3 text-green-600" size={14} />
                      +91 63780 10128
                    ...
                    <p className="text-sm flex items-center text-slate-600">
                      <FaEnvelope className="mr-3 text-blue-600" size={14} />
                      <a href="mailto:ug.placement@iitrpr.ac.in" className="text-blue-600 hover:text-blue-800 transition-colors duration-200 hover:underline">
                ...
                <div>
                  <p className="text-lg font-semibold mb-2 text-slate-800">Hardik Jain</p>
                  <div className="space-y-2">
                    <p className="text-sm flex items-center text-slate-600">
                      <FaPhone className="mr-3 text-green-600" size={14} />
                      +91 90043 50656
                    ...
                    <p className="text-sm flex items-center text-slate-600">
                      <FaEnvelope className="mr-3 text-blue-600" size={14} />
                      <a href="mailto:cdpc.outreach@iitrpr.ac.in" className="text-blue-600 hover:text-blue-800 transition-colors duration-200 hover:underline">
        ...
        <div className="hidden md:block">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between mb-12 pb-8 border-b border-blue-200">
            {/* Logo Section */}
            <div className="flex items-center space-x-6 mb-6 lg:mb-0">
              ...
              <div>
                ...
                <div className="flex items-start text-slate-600">
                  <FaMapMarkerAlt className="mr-2 mt-1 text-blue-500 flex-shrink-0" size={14} />
            ...
            <div className="lg:col-span-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div className="bg-white rounded-lg p-6 border border-blue-200 shadow-sm">
                  <h4 className="font-bold mb-3 text-blue-700 text-xl">Dean CEOA</h4>
                  <p className="text-lg mb-3 font-semibold text-slate-800">Dr. Sarang P. Gumfekar</p>
                  <div className="space-y-2">
                    <p className="text-sm flex items-center text-slate-600">
                      <FaPhone className="mr-3 text-green-600" size={14} />
                      +91 76200 63191
                ...
                <div className="bg-white rounded-lg p-6 border border-blue-200 shadow-sm">
                  <h4 className="font-bold mb-3 text-blue-700 text-xl">Faculty In-Charge</h4>
                  <p className="text-lg mb-3 font-semibold text-slate-800">Dr. Tharamani C.N.</p>
                  <div className="space-y-2">
                    <p className="text-sm flex items-center text-slate-600">
                      <FaPhone className="mr-3 text-green-600" size={14} />
                      +91 82838 40769
                ...
                <div className="bg-white rounded-lg p-6 border border-blue-200 shadow-sm">
                  <h4 className="font-bold mb-3 text-blue-700 text-xl">Organizer</h4>
                  <p className="text-lg mb-3 font-semibold text-slate-800">Nikhil Garg</p>
                  <div className="space-y-2">
                    <p className="text-sm flex items-center text-slate-600">
                      <FaPhone className="mr-3 text-green-600" size={14} />
                      +91 63780 10128
                ...
                <div className="bg-white rounded-lg p-6 border border-blue-200 shadow-sm">
                  <h4 className="font-bold mb-3 text-blue-700 text-xl">Organizer</h4>
                  <p className="text-lg mb-3 font-semibold text-slate-800">Hardik Jain</p>
                  <div className="space-y-2">
                    <p className="text-sm flex items-center text-slate-600">
                      <FaPhone className="mr-3 text-green-600" size={14} />
                      +91 90043 50656
